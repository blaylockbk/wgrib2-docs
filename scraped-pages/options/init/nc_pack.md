...
>Description: init  X      pack/check limits of all NEW input variables, X=min:max[:byte|short|float]

_Docs derived from <https://www.cpc.ncep.noaa.gov/products/wesley/wgrib2/nc_pack.html>_