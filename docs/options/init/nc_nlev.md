...
>Description: init  X      netcdf, X = max LEV dimension for {TIME,LEV,LAT,LON} data

_Docs derived from <https://www.cpc.ncep.noaa.gov/products/wesley/wgrib2/nc_nlev.html>_